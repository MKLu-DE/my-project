...
html_section_style = {"color":"#6E6E6E", 'textAlign':'left', "fontWeight":"bold", 
                    'font-size':'20px', 'margin-top': '0.6em', 'margin-bottom': '0.6em'}

input_style  = {'width':"100%", 'textAlign':'center'}

button_style0 = {'width':'100%', 'margin-bottom': '0.4em', 
                 'margin-top': '0.4em'}
radio_style = {'width':'100%', 'textAlign':'right', 'margin-top':'0.4em'}
...
def button(buttonName:str, 
           buttonID:str, 
           buttonColor:Optional[str]="blue", 
           buttonStyle:Optional[dict]=button_style0,
           outline:Optional[bool]=False):
    
    """ 
    - buttonColor = {"blue": "primary", "grey": "secondary", "green": "success", "orange": "warning", "red": "danger", "light blue": "info", "white": "light", "black": "dark"}

    - buttonStyle = {'width':'100%', 'margin-bottom': '0.5em', 'margin-top': '0.5em'}
    """
...
def label_input_text(labelName:str, 
                     labelWidth:Optional[int]=7, 
                       inputWidth:Optional[int]=5, 
...
def label_input_number(labelName:str, 
                       labelWidth:Optional[int]=7, 
                       inputWidth:Optional[int]=5, 
                       inputID:Optional[str]=None,
                       placeholder:Optional[Union[float, int]]=None,
                        ...
                        style_label:Optional[dict]={},
                        style_box:Optional[dict]=card_style):
    return dbc.Row(children=[
            dbc.Label(labelName, width=labelWidth, style=style_label),
            dbc.Col(
                dbc.Input(
                    type="number", 
                    id=inputID, 
...
def card(cardHeader: str, 
         content: list, 
         style: Optional[dict]={'font-weight':'bold', 'font-size':'20px'}
         ):
    content_layout = []
    for i in content:
...
def table(columnName:list, columnType:list, tableID:str, 
        ...
        sort_action:Optional[Union[str, bool]]='none', 
        filter_action:Optional[Union[str, bool]]='none', 
        data:Optional[list]=[], 
        style_data:Optional[dict]={},
        style_header:Optional[dict]={'backgroundColor': 'rgb(192,192,192)',
                            'fontWeight': 'bold',
                            'font-size': '15px',},
        style_cell: Optional[dict]= {
                            'font-size': '13px', 'minWidth': 95, },
        style_table: Optional[dict]= {
                            'overflowY': 'auto',
                            'overflowX': 'auto',
                            'margin-top': '0.5em',
    ...
    sort_action = ["custom","native","none"]
    dropdownName = ["class"]
    dropdownContent = 
        {}: no dropdown
...
def dropdownMenu(dropdownName:str, 
                 dropdownID:str, 
                 labelWidth:Optional[int]=7, 
                 dropdownWidth:Optional[int]=5,
...
def notification(noticeText:str, 
                 headerText:str, 
                 iconType:str, 
                 duration:int, 
                 dismissable:bool):
...
def radio_select(radioLabel:str, 
                 radioID:str, 
                 radioItemsLabel:list, 
                 radioItemsValue:list, 
                 labelWidth:Optional[int]=7, 
                 radioWidth:Optional[int]=5,
                 labelCheckedStyle:Optional[dict]={'color': 'green','width': '100%'},
...
def app_layout(contents:list, 
               navigationBarColor:Optional[str]="green"):
